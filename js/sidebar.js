...
(function() {
  const navData = [
    ...
    },
    {
      ...
      prefix: 'api-docs/',
      children: [
        { label: '产品介绍', page: 'product-intro' },
        { label: '说明', page: 'overview' },
        { label: '获取token', page: 'get-token' },
        { label: '小文件上传', page: 'upload-small' },
        { label: '大文件上传', page: 'upload-large' },
        { label: '文件下载', page: 'download' },
        { label: '用户空间信息', page: 'user-storage' },
        { label: '文件列表', page: 'file-list' },
        { label: '删除文件', page: 'delete-file' },
        { label: 'SDK集成', page: 'sdk' },
        { label: '网关节点', page: 'gateway-nodes' },
      ]
    },
    {
      type: 'group',
